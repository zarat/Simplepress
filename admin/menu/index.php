...
<div class ="sp-content">
    ...
    <div class="sp-content-item">
        ...
        <div class="sp-content-item-head"><?php echo $system->_t("menu_manager"); ?></div>
        <div class="sp-content-item-head-secondary"><?php echo $system->_t("menu_manager_description"); ?></div>
...
<script src="../admin/menu/jquery.nestable.js"></script>
