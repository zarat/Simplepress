...
var global_day = "";
var global_hours = "00";
var global_minutes = "00";

  var datePickerTpl = '<div class="yearMonth">'+
  '<a class="previous">&lsaquo;</a><span class="year">{y}</span>-<span class="month">{m}</span><a class="next">&rsaquo;</a></div>' +
  '<div class="days"><a>1</a><a>2</a><a>3</a><a>4</a><a>5</a><a>6</a><a>7</a><a>8</a><a>9</a><a>10</a><a>11</a><a>12</a><a>13</a><a>14</a><a>15</a><a>16</a><a>17</a><a>18</a><a>19</a><a>20</a><a>21</a><a>22</a><a>23</a><a>24</a><a>25</a><a>26</a><a>27</a><a>28</a><a>29</a><a>30</a><a>31</a></div>';
  ...
  function setMonthYear(dp, month, year, input) {
    ...
    if(input && input.value) {
      ...
      if(date[1] == curYear && date[2] == curMonth) {
      	dp.querySelector(".days a:nth-child(" + parseInt(date[0]) + ")").className = "selected";
      }
    }
  }
  ...
  document.querySelectorAll(".datepicker").forEach(function(input) {
    ...
    dp.querySelectorAll(".days a").forEach(function(a){
    	a.addEventListener("click", function(e) {
    		...
    		global_day = this.text.padStart(2, "0");
            input.value = this.text.padStart(2, "0") + "." + dp.querySelector(".month").textContent + "." + dp.querySelector(".year").textContent;
      });
    });
