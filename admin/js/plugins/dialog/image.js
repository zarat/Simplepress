...
SUNEDITOR.plugin.image = {
    ...
    update_image: function () {
        ...
        var container = SUNEDITOR.dom.getParentNode(contextImage._imageElement, '.container');
        var cover = SUNEDITOR.dom.getParentNode(contextImage._imageElement, '.media-cover');
        var newEl;
    ...
    onClick_imageResizeBtn: function (e) {
        ...
        if (/^\d+$/.test(command)) {
            ...
            var imageContainer = SUNEDITOR.dom.getParentNode(contextImage._imageElement, '.container');
