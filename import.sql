...
(NULL,	1,	'Home',	'../',	0,	1),
(NULL,	1,	'Testseite',	'../?type=page&id=3',	0,	2);
...
(1,	'category',	'Allgemein',	'',	'',	'Deine erste Kategorie zu Allgemeinen Themen',	1491560699,	1,	'1'),
(2,	'post',	'Ein Testpost',	'',	'',	'Ich bin ein Post',	1515107311,	1,	'1'),
(3,	'page',	'Eine Testseite',	'',	'',	'Ich bin eine Seite',	1515507779,	1,	'1');
